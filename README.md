...
README.md is based on README.txt - updated on 29/01/2018 - v1.22.11 - latest version can be found here: https://github.com/MultiPoolMiner/MultiPoolMiner/blob/master/README.txt
